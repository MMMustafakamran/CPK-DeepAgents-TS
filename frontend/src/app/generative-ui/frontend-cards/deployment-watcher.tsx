...
//
// In this repo it is also the first thing to throw: its bare `useAgent()`
// asks for `"default"`, which this runtime does not register, and after
// `/info` answers that is "Agent 'default' not found after runtime sync".
